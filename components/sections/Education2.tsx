				...
				<div className="container">
					<div className="row">
						<div className="col-lg-6 pt-3">
							<div className="rounded-3 position-relative h-100 overflow-hidden box-linear-animation">
						...
						<div className="col-lg-6 pt-3">
							<div className="bg-3 rounded-3 p-md-6 p-3 position-relative h-100 overflow-hidden box-linear-animation">
								<div className="d-flex align-items-center">
